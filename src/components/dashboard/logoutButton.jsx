...
const LogoutButton = () => {
  ...
  return (
    <>
      <button
        href="#"
        className="w-full flex items-center p-2 text-gray-900  dark:text-white hover:rounded-lg hover:bg-red-500 hover:text-white dark:hover:bg-gray-700 group"
      ...
      >
        ...
        <p className="ms-3 whitespace-nowrap group-hover:text-white" >
          Logout
        </p>
      </button>
    </>
